...
},{}],"7ov2":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $cecd54 = exports.default || module.exports;
      
      if (typeof $cecd54 === 'function') {
        $cecd54 = $cecd54.options;
      }
    
        /* template */
        Object.assign($cecd54, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"category"},[_c('div',{staticClass:"category__title",on:{"click":_vm.onOpen}},[_c('div',[_c('strong',{staticStyle:{"font-size":"16px"}},[_vm._v(_vm._s(_vm.page.name))]),_c('span',[_vm._v("（"+_vm._s(_vm.categories.length)+"）")])]),_vm._v(" "),_c('div',{staticClass:"category__icon"},[_c('i',{class:[ 'iconfont', 'icon-' + _vm.page.icon ]})])]),_vm._v(" "),_c('div',{staticClass:"category__body is-opened"},_vm._l((_vm.categories),function(category,category_index){return _c('router-link',{staticClass:"category__item",attrs:{"to":'/questions/' + _vm.page.id + '/' + category.id}},[_c('div',{staticClass:"category__itemname"},[_vm._v("\n        "+_vm._s(category.name)+"（"+_vm._s(category.questions ? category.questions.length : 0)+"）\n      ")]),_vm._v(" "),_c('div',{staticClass:"category__itemmore"},[_c('i',{staticClass:"iconfont icon-arrow"})])])}),1)])}
var staticRenderFns = []
...
},{}],"7boC":[function(require,module,exports) {
module.exports = [{
  "name": "通用知识",
  "icon": "align-right",
  "categories": [{
    "name": "设计模式",
    "file": "common/design-pattern.md",
    "id": "5bb84214",
    "questions": [{
      "question": "发布订阅模式 和 观察者模式 有什么关系？",
      "question_body": "",
      "answer": "<p>发布订阅模式属于广义上的观察者模式，是其最常见的一种实现</p>\n<p>发布订阅模式会比「典型的观察者模式」多一个「发布订阅中心」</p>\n<p><strong>典型观察者模式</strong></p>\n<pre class=\"language-unknown\"><code>+-----------+  Fire Event  +------------+\n|           |-------------&gt;|            |\n|  Subject  |              |  Observer  |\n|           |&lt;-------------|            |\n+-----------+   Subscribe  +------------+</code></pre><p><strong>发布订阅模式</strong></p>\n<pre class=\"language-unknown\"><code>+-----------+               +---------------+  Fire Event  +------------+\n|           | Publish Event |               |-------------&gt;|            |\n| Publisher |--------------&gt;| Event Channel |              | Subscriber |\n|           |               |               |&lt;-------------|            |\n+-----------+               +---------------+   Subscribe  +------------+</code></pre><p>参考：<a href=\"https://www.zhihu.com/question/23486749\">https://www.zhihu.com/question/23486749</a></p>\n"
    }, {
      "question": "用代码实现发布订阅模式",
      "question_body": "",
      "answer": "<p>emmm...todo</p>\n"
    }]
  }, {
    "name": "网络",
    "file": "common/network.md",
    "id": "810a0276",
    "questions": [{
      "question": "TCP 建立连接 为什么是三次握手？",
      "question_body": "",
      "answer": "<p>第一次：client -&gt; server，你能收到我的消息吗？</p>\n<p>第二次：client &lt;- server，能收到，你能收到我的消息吗？</p>\n<p>第三次：client -&gt; server，我也能收到你的消息</p>\n<p>信道不可靠，至少需要三次握手来确保信道是<strong>&quot;可用的&quot;</strong>，<strong>确保双方能收能发</strong></p>\n<h2>为什么一定要三次握手？两次握手就不行呢？为什么三次就是可靠的呢？</h2>\n<p><img src=\"https://haitao.nos.netease.com/e01a894b-c39d-44aa-af6c-274182db37c6_822_424.png\" alt=\"屏幕快照 2019-02-24 下午3.11.38.png\"></p>\n<p>假设客户端与服务端直接只有两次握手，客户端第一次发送连接的请求因为网络原因在网络结点中发生了滞留（没有丢失）；此时客户端因为没有收到确认报文，又发了第二个连接的请求（syn），此时服务端发送了（ack+syn）表回复确认收到；如果是两次，此时开始传输数据，数据发送完关闭连接。  </p>\n<p>此时网络通畅了，第一个滞留的请求到了服务端，服务端进行了回复（ack+syn），如果只有两次握手的话，又开始了客户端和服务端之间的连接建立，但这是没必要的，造成了错误与浪费。  </p>\n<p>所以如果有三次握手的话，就算服务端发出了收到的确认回复，客户端也不会再发出ack的确认标记，服务端就知道原来客户端没有要建立连接，所以之前滞留的请求就不会再创建连接了，也就避免了资源浪费。</p>\n"
    }, {
      "question": "TCP 释放连接 为什么是四次挥手",
      "question_body": "",
      "answer": "<p>前两次用来释放 client -&gt; server 方向的连接</p>\n<p>后两次用来释放 client &lt;- server 方向的连接</p>\n<h2>为什么是四次挥手？多了的一次挥手相比于握手多在了哪里呢？</h2>\n<p><img src=\"https://haitao.nos.netease.com/18d1353c-b18a-4bc8-9ae6-eb7ff67e34dd_797_473.png\" alt=\"\"></p>\n<p>先看下过程</p>\n<ul>\n<li>step1: 客户端向服务端发出 FIN+seq 标记，表示客户端要主动关闭连接，停止发送数据</li>\n<li>step2: 服务端发出 ACK + seq标记，发出确认回复的报文，此时，服务端进入<strong>半关闭状态</strong>（客户端已经没有数据发出了，但服务端若发出数据，客户端要接收）<strong>因为此时服务端的数据不一定完全发送完了</strong></li>\n<li>step3: 服务端最后的数据发送完了，就像客户端发送FIN+ACK 连接释放的报文, 服务器此时进入了等待客户端最后确认的状态</li>\n<li>step4: 客户端收到服务端连接释放的报文后，发出ACK+seq表示确认，服务器收到了客户端发出的确认报文猴就立即进入了closed状态</li>\n</ul>\n<p>所以可以看出，挥手多的一个步骤是在step3, ACK 和 FIN 在服务端分成了2步发出，如果服务端再收到客户端发来的FIN报文后，如果没有数据传输了，那么FIN+ACK是可以合并的</p>\n<p>参考资料：\n1.https://blog.csdn.net/qzcsu/article/details/72861891\n2.《图解http》\n3.cs50-tcp https://www.youtube.com/watch?v=GP7uvI_6uas&amp;t=1s\n4.cs50-http https://www.youtube.com/watch?v=4axL8Gfw2nI</p>\n"
    }, {
      "question": "介绍下 HTTP/2 的一些新特性",
      "question_body": "",
      "answer": "<ul>\n<li>采用了二进制格式传输数据（相比 HTTP/1.x 的文本格式）</li>\n<li>多路复用</li>\n<li>header 压缩</li>\n<li>服务器推送</li>\n</ul>\n"
    }, {
      "question": "HTTP/2 多路复用？",
      "question_body": "",
      "answer": "<p>同一个域名下，多个请求可以复用同一个 TCP 连接</p>\n"
    }, {
      "question": "HTTP/2 服务器推送（Server Push）？",
      "question_body": "",
      "answer": "<p>服务器发送 HTML 后，需要等待浏览器解析 HTML 后发起内嵌资源的请求，才会响应 JavaScript、CSS、images 等资源，Server Push 允许服务器提前推送这些资源到浏览器的缓存中，消除了中间的等待时间</p>\n<blockquote>\n<p><a href=\"https://http2.github.io/faq/\">HTTP/2 FAQ</a></p>\n</blockquote>\n"
    }]
  }, {
    "name": "算法",
  ...
  "categories": [{
    ...
    "questions": [{
      "question": "常见的缓存类型",
      "question_body": "",
      "answer": "<p>按缓存位置分：</p>\n<ul>\n<li>Service Wroker</li>\n<li>Memory Cache</li>\n<li>Disk cache</li>\n</ul>\n<p>按失效策略分：</p>\n<ul>\n<li><p>强缓存</p>\n<ul>\n<li>用Cache-Control, Expires headers来控制，特点是如果设置了对应的缓存时间，在该时间内不会发任何请求到服务器。</li>\n</ul>\n</li>\n<li><p>协商缓存</p>\n<ul>\n<li>用ETag, Last-Modified, If-None-Match headers来控制，特点是会先发一个请求给服务器验证缓存是否有效。</li>\n</ul>\n</li>\n</ul>\n"
    }, {
      "question": "缓存查找的顺序",
      "question_body": "",
      ...
      "question": "Cache from Memory 和 Cache from Disk 的区别",
      "question_body": "",
      ...
      "question_body": "",
      "answer": "<p>如果资源被客户端缓存，在缓存失效前，在不更改资源网址的情况下，是没办法做到的，所以我们在资源内容发生变化时(利用content-hash)，需要更改它的网址，强制用户重新下载</p>\n"
    }, {
      "question": "HTTP Cache 实践举例",
      "question_body": "",
      "answer": "<ul>\n<li>html - Cache-Control: no-cache</li>\n<li>js/css - Cache-Control: max-age=31536000</li>\n<li>image - Cache-Control: max-age=86400</li>\n</ul>\n"
    }, {
      "question": "Cache-Control 默认值/行为",
      "question_body": "",
      "answer": "<p>TODO</p>\n<p>如果没有设置Cache-Control，根据规范，浏览器可能会缓存也可能不会</p>\n<blockquote>\n<p>Unless specifically constrained by a cache-control \n directive, a caching system MAY always store a successful response </p>\n</blockquote>\n"
    }, {
      "question": "Cache-Control max-age=0 和 no-cache 的关系",
      "question_body": "",
      "answer": "<p>no-cache 等价于 max-age=0, must-revalidate, 意思是no-cache并不意味着不缓存，而是意味着在使用缓存之前一定要进行验证。</p>\n<!--\n参考：\nhttps://developers.google.com/web/fundamentals/performance/optimizing-content-efficiency/http-caching\nhttps://mp.weixin.qq.com/s/cUqkG3NETmJbglDXfSf0tg\nhttps://tools.ietf.org/html/rfc7234#section-5.2.1\nhttps://jakearchibald.com/2016/caching-best-practices/?utm_campaign=chrome_series_catchingbestpractices_072717&utm_source=chromedev&utm_medium=yt-desc\nhttps://www.v2ex.com/t/356353\n-->\n"
    }]
  }, {
    "name": "性能优化",
    ...
    "questions": [{
      ...
      "question": "JSONP 有什么限制？",
      "question_body": "",
      "answer": "<p>只能发送 GET 请求</p>\n"
    }, {
      "question": "为什么 WebSocket 没有同源策略的限制",
      "question_body": "",
      "answer": "<p>浏览器发送了 <code>Origin</code> 请求头，服务端可以对此进行校验</p>\n"
    }, {
      "question": "描述下预检请求（Preflight request）",
      "question_body": "",
      "answer": ""
    }, {
      "question": "form 表单可以跨域吗？",
      "question_body": "",
      "answer": "<p>可以，因为表单提交后会刷新页面，原页面的js拿不到响应内容</p>\n"
    }]
  }, {
    "name": "事件循环",
...
},{}],"ezLQ":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $68ad0a = exports.default || module.exports;
      
      if (typeof $68ad0a === 'function') {
        $68ad0a = $68ad0a.options;
      }
...
},{"../components/Category":"TU+R","../data.json":"7boC"}],"reR6":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  data: function data() {
    ...
    var page = _data.default.find(function (p) {
      return p.id === pid;
    });
...
exports.default = _default;
        var $8a1de4 = exports.default || module.exports;
      
      if (typeof $8a1de4 === 'function') {
        $8a1de4 = $8a1de4.options;
      }
    
        /* template */
        Object.assign($8a1de4, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"questions"},[_c('div',{staticClass:"questions__head"},[_c('div',{staticClass:"questions__back",on:{"click":_vm.onHome}},[_c('i',{staticClass:"iconfont icon-back"})]),_vm._v(" "),_c('h3',{staticClass:"questions__title"},[_vm._v(_vm._s(_vm.title))])]),_vm._v(" "),_c('div',{staticClass:"questions__body"},_vm._l((_vm.questions),function(question,i){return _c('div',{staticClass:"question"},[_c('div',{ref:'fullscreen_' + i,refInFor:true,staticClass:"question__fullscreenroot"},[_c('div',{staticClass:"question__head"},[_c('div',{staticClass:"question__question"},[_vm._v(_vm._s(question.question))]),_vm._v(" "),_c('div')]),_vm._v(" "),_c('div',{staticClass:"question__body",domProps:{"innerHTML":_vm._s(question.question_body)}})]),_vm._v(" "),_c('div',{staticClass:"question__answer",domProps:{"innerHTML":_vm._s(question.answer)}})])}),0)])}
var staticRenderFns = []
...
},{"../data.json":"7boC"}],"Focm":[function(require,module,exports) {
"use strict";
...
_vueRouter.default.install(_vue.default);
...
//# sourceMappingURL=src.1316316c.map