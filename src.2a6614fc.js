...
},{"../components/Category":33,"../data.json":31}],16:[function(require,module,exports) {
'use strict';
...
exports.default = {
  ...
  data: function data() {
    ...
    var page = _data2.default.find(function (p) {
      return p.id === pid;
    });
...
},{"../data.json":31}],4:[function(require,module,exports) {
'use strict';
...
_vueRouter2.default.install(_vue2.default);
...
},{"vue":8,"vue-router":10,"prismjs/themes/prism-tomorrow.css":12,"./pages/Categories":14,"./pages/Questions":16,"./css/global.less":12}]},{},[4], null)
//# sourceMappingURL=src.9625100a.map